// Based on Listing 8.2 2 Dimensional Array for scoring the point totals of
// 5 players in 3 different games; page 174
...
// ...for 5 players and 3 games.. 5 copies of array with 3 spots (columns vs rows)
//              [5] is columns x [3] is rows
//
//     p1  p2  p3  p4  p5
//  g1  x   x   x   x   x
//  g2  x   x   x   x   x
...
// int scores[5][3]; but we're skipping zero to simplify printing the scores out so...
int scores[6][4];
